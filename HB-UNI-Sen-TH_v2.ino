...
public:
    void init(uint8_t msgcnt, int16_t temp, uint8_t humidity, uint16_t batteryVoltage, int16_t dewpoint, bool batLow)
    {
        ...
        // dewpoint
        pload[3] = (dewpoint >> 8) & 0xff;
        pload[4] = dewpoint & 0xff;        
    }
};
...
public:
    ...
    virtual void trigger(AlarmClock& clock)
    {
        ...
        measure();
        msg.init(msgcnt, temperature10, humidity, batteryVoltage, dewpoint10, device().battery().low());
